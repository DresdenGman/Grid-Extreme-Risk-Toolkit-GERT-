...
export default function WinterLoadBrief() {
  ...
  return <article className="mx-auto max-w-5xl space-y-8 pb-14">
    ...
    <section className="border border-[#175a73] bg-[#dfe8ea] p-5 sm:p-6"><span className="technical-label text-[#175a73]">Try a five-minute counterexample</span><h2 className="display-serif mt-3 text-3xl">Same meter. Two worlds.</h2><p className="mt-3 text-sm leading-6">Build two invented situations with identical electricity readings but different unmet demand. Change an assumption and inspect the arithmetic yourself.</p><Link href="/briefs/same-meter" className="mt-4 inline-block text-sm font-semibold underline">Try the interactive explanation →</Link></section>
    <BriefActions />
